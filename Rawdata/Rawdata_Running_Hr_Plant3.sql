SELECT
    ...
    , [Compressor_01_IQF5] + [Compressor_02_IQF5] + [Compressor_03_IQF6] + [Compressor_04_Cold_Str] +[Compressor_05_Roomtemp] + [Compressor_06_Roomtemp] + [Compressor_07_Spare] + [Compressor_08_Office]+ [Compressor_09_Office] AS [Total_Compressor]
FROM (
    SELECT
        [ID],
        [Date],
    ...
    FROM [Sustainability].[dbo].[Rawdata_Running_Hr_Plant3]
