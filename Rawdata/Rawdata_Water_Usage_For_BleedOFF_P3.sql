SELECT
    [Date]
      ...
      ,(Total_Bleed_off_No_01 + Total_Bleed_off_No_02 + Total_Bleed_off_No_03 + Total_Bleed_off_No_04) as[Total_Line5_6]
FROM (
    SELECT
        [ID],
        [Date],
    ...
    FROM [ISMPALI].[dbo].[ut_sus_rw_data_water_usage_for_bleed_off_p3]
