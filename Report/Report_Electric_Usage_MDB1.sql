INSERT INTO [Sustainability].[dbo].[Report_Electric_Usage_MDB1]
    (
    [Date]
    ,[Unit]
    ,[PEA_Meter]
...
WHERE NOT EXISTS (
    SELECT 1
FROM [Sustainability].[dbo].[Report_Electric_Usage_MDB1]
WHERE [Report_Electric_Usage_MDB1].[Date] = Subquery.[Date]
);
