INSERT INTO [ISMPALI].[dbo].[ut_sus_rpt_electric_usage_mdb4]
    (
    [Date]
    ,[Unit]
    ,[MDB4]
...
WHERE NOT EXISTS (
    SELECT 1
FROM [ISMPALI].[dbo].[ut_sus_rpt_electric_usage_mdb4]
WHERE [ut_sus_rpt_electric_usage_mdb4].[Date] = Subquery.[Date]
);
